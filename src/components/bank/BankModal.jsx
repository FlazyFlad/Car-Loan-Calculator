...
const BankModal = ({isOpen, onClose}) => {
    ...
    // maxCredit is show as 030 000 000, so we need to remove zeros from the beginning
    ...
    return (
        ...
        >
            <ModalContent>
                {(onClose) => (
                    <>
                        <ModalHeader className="flex flex-col gap-1 text-3xl border-none">{modalTitle}</ModalHeader>
                        <ModalBody>
                            {banks?.map((bank, index) => (
                                <div key={index} className="flex flex-col gap-1 border border-gray-600 rounded-xl p-2 text-gray-600 text-sm">
                                    ...
                                    <div className="flex flex-row gap-1 items-center">
                                        ...
                                        <div>{maxCreditWithoutZeros} tenge</div>
                                    </div>
                                </div>
                            ))}
                        </ModalBody>
